...
export const translations = {
  en: {
    ...
    chat: {
      ...
      placeholder: 'e.g. 60 min upper body, no machines',
      ...
      welcome:
        "Hi! Tell me what you want — for example, '45 min back and biceps with dumbbells'. Or use the guided form.",
    },
    form: {
      goal: 'Goal',
      muscle: 'Muscle group',
  ...
  es: {
    ...
    chat: {
      ...
      placeholder: 'Ej.: 60 min tren superior, sin máquinas',
      ...
      welcome:
        '¡Hola! Dime qué quieres — por ejemplo, "45 min de espalda y bíceps con mancuernas". O usa el formulario guiado.',
    },
    form: {
      goal: 'Objetivo',
